  ...
  (symbol-overlay-match-keyword-list
   ...
   (append clojure-font-lock-extra-keywords
           '("primitives-classnames" "+'" "decimal?" "restart-agent" "sort-by"
             ...
             "keep-indexed" "cond->>" "subs" "ref-min-history" "set" "take-last"
             "bit-set" "reader-conditional" "gen-class" "qualified-keyword?"
             "while" "->Eduction" "butlast" "satisfies?" "line-seq"
             "unchecked-subtract-int" "*print-namespace-maps*" "take-nth" "first"
             "re-groups" "seq?" "dec'" "ns-unmap" "println-str" "with-bindings*"
             ...
             "ns-publics" "<" "*source-path*" "with-loading-context" "test" "rest"
             ...
             "unchecked-long" "aset-long" "some?" "unchecked-negate" "remove-tap"
             ...
             "re-pattern" "min" "pop!" "chunk-append" "prn-str" "with-precision"
             "format" "reversible?" "shutdown-agents" "conj" "bound?"
             "transduce" "lazy-seq" "*print-length*" "*file*" "compare-and-set!"
             "*use-context-classloader*" "await1" "let" "ref-set"
             "pop-thread-bindings" "interleave" "printf" "map?" "->" "defstruct"
             ...
             "unchecked-add-int" "unquote-splicing" "hash-ordered-coll" "future"
             ...
             "*print-meta*" "when" "int" "map-entry?" "ns-refers" "rand" "second"
             ...
             "ensure-reduced" "*'" "instance?" "with-open" "mix-collection-hash"
             ...
             "loop" "add-classpath" "bit-flip" "long-array" "descendants" "merge"
             "accessor" "integer?" "mapv" "partition-all" "partition-by"
             "numerator" "object-array" "with-out-str" "condp" "derive"
             "load-string" "special-symbol?" "ancestors" "subseq" "error-handler"
             "gensym" "cond" "ratio?" "delay?" "intern" "print-simple" "flatten"
             "doubles" "halt-when" "with-in-str" "remove-watch" "ex-info" "ifn?"
             ...
             "keys" "rationalize" "load-file" "distinct?" "pos-int?" "extenders"
             "unchecked-short" "methods" "odd?" "->ArrayChunk" "float-array" "*3"
             ...
             "destructure" "*assert*" "defmulti" "chars" "str" "next" "hash-map"
             ...
             "resolve" "compare" "complement" "*compiler-options*" "*print-dup*"
             "defrecord" "with-redefs-fn" "sequence" "constantly"
             "get-proxy-class" "make-array" "shorts" "completing" "update-proxy"
             "unchecked-negate-int" "hash-unordered-coll" "repeat" "unchecked-inc"
             "*reader-resolver*" "nthnext" "and" "create-struct" "get-validator"
